...
const PopularRoutesSection = () => {
  ...
  return (
    <div className="mt-16 sm:mt-20 md:mt-24">
      ...
      <div className="mb-16 sm:mb-20 md:mb-24 bg-gradient-to-r from-[#0B3B2E] to-lime-900 rounded-xl shadow-lg overflow-hidden">
          ...
          {popularRoutes.map((route, index) => (
            <div key={index} className="bg-white/10 p-4 rounded-lg">
              <div className="flex justify-between items-center">
                ...
                <Button
                  variant="default"
                  className="bg-[#062d23] hover:bg-[#062d23]/70 rounded-full py-1 px-2 sm:py-2 sm:px-3 text-xs sm:text-sm"
                >
